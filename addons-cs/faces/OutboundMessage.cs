...
public record HelloMessage(int ProtocolVersion, int AddonApiVersion, string[] Capabilities) : Message;
...
public record ErrorMessage(ulong Id, string Error) : Message;
public record ResponseMessage(ulong Id, ClusterResult Result) : Message;
